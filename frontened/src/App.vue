    ...
    <Teleport to="body">
      <div class="toast-container" aria-live="polite">
        <TransitionGroup name="toast-item">
          ...
          >
            <!-- Success icon -->
            <svg v-if="t.type === 'success'" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
            ...
            <button class="toast-close" @click="dismissToast(t.id)" aria-label="关闭提示">&times;</button>
          </div>
        </TransitionGroup>
      </div>
    </Teleport>
